...
export const wikiChunkSize = Number.parseInt(runtimeEnv('WIKI_CHUNK_SIZE', '3200'), 10);
export const wikiChunkOverlap = Number.parseInt(runtimeEnv('WIKI_CHUNK_OVERLAP', '400'), 10);
